...
var insertData = function(connection, callback) {
	...
	async.waterfall([(done)=>connection.query("INSERT INTO Module (ModuleID, Name, Description, Year, Credits, LectureDay, LectureTime, CourseworkPercentage, Faculty) VALUES"+
																				"('5CCS2OSC', 'Operating Systems and Concurrency', 'OPERATING SYSTEMS AND CONCURRENCY DESCRIPTION', 5, 15, 'Wednesday', '10:00:00', 015.00, 'Faculty of Natural and Mathematical Sciences'),"+
																				"('4CCS1FC1', 'Foundations of Computing 1', 'FOUNDATIONS OF COMPUTING 1 DESCRIPTION', 4, 15, 'Monday', '14:00:00', 000.00 ,'Faculty of Natural and Mathematical Sciences'),"+
																				"('4CCS2DBS', 'Database Systems', 'DATABASE SYSTEMS DESCRIPTION', 4, 15, 'Friday', '11:00:00', 020.00, 'Faculty of Natural and Mathematical Sciences'),"+
																				"('5CCS2SEG', 'Software Engineering Group Project', 'SOFTWARE ENGINEERING DESCRIPTION', 5, 30, 'Monday', '12:00:00', 085.00, 'Faculty of Natural and Mathematical Sciences'),"+
																				"('5CCS1FC2', 'Foundations of Computing 2', 'FOUNDATIONS OF COMPUTING 1 DESCRIPTION', 5, 15, 'Wednesday', '14:00:00', 000.00 ,'Faculty of Natural and Mathematical Sciences'),"+
																				"('5CCS1INS', 'Internet Systems', 'INTERNET SYSTEMS DESCRIPTION', 5, 15, 'Thursday', '13:00:00', 020.00, 'Faculty of Natural and Mathematical Sciences'),"+
																				"('5SSMN210', 'Accounting', 'ACCOUNTING DESCRIPTION', 5, 15, 'Friday', '09:00:00', 020.00, 'Faculty of Social Science and Public Policy'),"+
																				"('7CCS2KLM', 'Aerodynamics', 'AERODYNAMICS DESCRIPTION', 7, 15, 'Friday', '09:00:00', 020.00, 'Faculty of Natural and Mathematical Sciences'),"+
																				"('4SSMN110', 'Economics', 'ECONOMICS DESCRIPTION', 4, 15, 'Tuesday', '13:00:00', 040.00 , 'Faculty of Social Science and Public Policy'),"+
																				"('7CCS2TDL', 'Todelete', 'Blah', 7, 15, 'Thursday', '13:00:00', 040.00 , 'Faculty of Social Science and Public Policy'),"+
																				"('6CCS1MAL', 'Matrix Algebra', 'MATRIX ALGEBRA DESCRIPTION', 6, 70, 'Thursday', '15:00:00', 025.00 , 'Faculty of Natural and Mathematical Sciences')", (err)=>done(err)),											
...
exports.MODULE_SUITE_BEFORE_EACH_DATA = {
	tables: {
		Module: [
			...
			{ModuleID:"6CCS1MAL", Name:"Matrix Algebra", Description:"MATRIX ALGEBRA DESCRIPTION", Year:3, Credits:70, LectureDay:"Thursday", LectureTime:"15:00:00", CourseworkPercentage:25 , Faculty:"Mathematics"},
...
exports.TAG_SUITE_BEFORE_EACH_DATA = {//TODO
	tables: {
		Module: [
		],
	},
